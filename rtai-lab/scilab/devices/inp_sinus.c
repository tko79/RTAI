...
void inp_sinus_init(int port,int nch,char * sName,double p1,
...
void inp_sinus_input(int port, double * y, double t)
{
  ...
  if(t<inpDevStr[id].dParam[4]) y[0]=0.0;
    ...
    angle=(t-inpDevStr[id].dParam[4])*inpDevStr[id].dParam[1]-inpDevStr[id].dParam[2];

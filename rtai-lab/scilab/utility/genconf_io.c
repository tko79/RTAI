...
void fill_act_and_sens()
{
    ...
    double t_samp;
    fscanf(fin,"%lf",&t_samp);
    fprintf(fout,"s/return(0.001)/return(%f)/g\n",t_samp);
	...
	sprintf(str_init,"%s_%s_init(%d,%d,\"%s\",%lf,%lf,%lf,%lf,%lf);",io,type,
		port,ch,name,dParam[0],dParam[1],dParam[2],dParam[3],dParam[4]);
